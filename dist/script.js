...
var images = function images() {
  ...
  imagePopup.style.display = 'none'; // imagePopup.style.width = '300px';
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function hideTabs() {
    content.forEach(function (item) {
      item.style.display = 'none'; // item.classList.remove('fade');
    });
  ...
  function showTabs() {
    ...
    tab[i].classList.add(activeClass); // content[i].classList.add('fade');
  }
